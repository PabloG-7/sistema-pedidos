...
import { Package, PlusCircle, BarChart3, Users, TrendingUp, Clock, Calendar, FileText } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="mb-2">
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Visão geral do seu sistema de pedidos
        </p>
      </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-white">R$ {stats.averageBudget}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="card">
            ...
            <div className="space-y-3">
              ...
              >
                <PlusCircle className="h-5 w-5 text-gray-600 dark:text-gray-400 mr-3" />
