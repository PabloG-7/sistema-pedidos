...
const Layout = () => {
  ...
  // DEFINIR navigation como array - ESTAVA FALTANDO ISSO!
  const navigation = [
  ...
  // Adicionar admin se for administrador
  if (isAdmin) {
    navigation.push({ name: 'Admin - Pedidos', href: '/admin/orders', icon: Package });
  }
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Sistema de Pedidos</span>
            </div>
